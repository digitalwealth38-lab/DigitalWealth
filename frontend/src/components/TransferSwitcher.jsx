...
import TransferUsers from "./Transferuser";
import TransferHistory from "./TransferHistory";

export default function TransferSwitcher() {
  ...
  return (
     <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-sky-100 flex flex-col items-center justify-center px-6 py-16">
      ...
      >
        Transfer  <span className="text-sky-500">Funds</span>
      </motion.h1>
