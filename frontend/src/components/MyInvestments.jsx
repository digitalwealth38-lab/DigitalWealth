...
setTotalProfitSum(totalProfit);
 ...
 <div className="text-center mb-12 overflow-visible">
  <h2 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-600 drop-shadow-md leading-relaxed inline-block">
    My Investments
  </h2>
